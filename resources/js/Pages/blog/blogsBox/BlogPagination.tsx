export default function BlogPagination({ max_pages }: { max_pages: number }) {
            ...
            if (
                ...
                pageNumbers.push(
                    <button
                        ...
                        onClick={() =>
                            (window.location.href = `/blog?page=${i}`)
                        }
                    >
                        {i}
                    </button>
    ...
    return (
        <section className="md:w-[483px] w-[250px] flex items-center md:gap-4 gap-2">
            <button
                onClick={() =>
                    (window.location.href = `/blog?search=${search_query}`)
                }
            ...
            <button
                onClick={() =>
                    (window.location.href = `/blog?page=${max_pages}&search=${search_query}`)
                }
            ...
            >
                ...
                >
                    <path
                        ...
                        fill={current_page == max_pages ? "#808282" : "#FEFFFF"}
                    />
                </svg>
            </button>
        </section>
