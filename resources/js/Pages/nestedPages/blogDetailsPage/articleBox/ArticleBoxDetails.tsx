...
export default function ArticleBoxDetails({ post }: { post: Post }) {
    return (
        <div className="2xl:w-[820px] xl:w-[793px] lg:w-[650px] w-[360px] h-auto rounded-tl-[100px] rounded-br-[100px] border border-primary-600 bg-bg-01 py-[34px] px-[32px] md:mb-0 mb-[50px]">
