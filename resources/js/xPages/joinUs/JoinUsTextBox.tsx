            ...
            <section className="md:w-[370px] xl:w-[430px] 2xl:w-[470px] w-full flex flex-col items-start gap-4 xl:mt-[173px] lg:mt-[80px] xl:mb-[174px] lg:mb-[80px] mb-8 xl:mr-[50px] lg:mr-8 lg:p-4 p-6">
                ...
                >
                    <>
                        ...
                        المتميز وساهم في تحقيق نجاحات جديدة
                    </>
                </TextContent>
                <ParagraphContent>
                    نبحث عن أفراد طموحين ومبدعين للانضمام إلى فريقنا.إذا كنت
                    مستعدًا لتحديات جديدة وترغب في المساهمة في نجاحاتنا، نرحب بك
                    لتكون جزءًا من عائلتنا المهنية.
                </ParagraphContent>
            </section>
        </section>
    );
