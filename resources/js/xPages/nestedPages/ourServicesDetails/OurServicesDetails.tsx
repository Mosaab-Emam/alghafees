...
import ParagraphContent from "../../../xcomponents/ParagraphContent";
    ...
    return (
        <>
            <section className="container md:mt-[211px] mt-[6rem] mb-[85px] relative">
                <div className="flex md:flex-row flex-col md:items-start items-center md:gap-28 gap-6">
                    ...
                    <div className="relative md:w-[478px] w-[299.083px] md:h-[478px] h-[292.127px] ">
                        <div
                            className="md:w-[478px] w-[299.083px] md:h-[478px] h-[292.127px] rounded-tl-[100px] rounded-br-[100px]"
                            style={{
                        ...
                        <div
                            className="md:w-[478px] w-[299.083px] md:h-[478px] h-[292.127px] absolute md:top-4 top-3 left-4  z-[-1] rounded-tl-[100px] rounded-br-[100px]"
                            style={{
                    ...
                    <div className="md:w-[340px] w-[360px] self-center">
                        <ParagraphContent>
                            إعداد دراسات الجدوى للمشاريع العقارية بطرق احترافية
                            تساعد عمالئنا على اتخاذ القرارات االستثمارية الصحيحة
                            بعد دراسة تلك االستثمارات وخصائصها والتعرف على نقاط
                            القوة والضعف وبذل العناية في دراسة السوق والعوامل
                            المؤثرة على كافة أنواع االستثمارات العقارية المختلفة
                            .
                        </ParagraphContent>
                    </div>
                </div>
