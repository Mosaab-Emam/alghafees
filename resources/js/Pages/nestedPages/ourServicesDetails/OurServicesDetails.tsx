			...
			<section className='container md:mt-[211px] mt-[6rem] mb-[85px] relative'>
				<div className='flex md:flex-row flex-col md:items-start items-center md:gap-28 gap-6'>
					...
					<div className='md:w-[340px] w-[360px] self-center'>
						<ParagraphContent>
							إعداد دراسات الجدوى للمشاريع العقارية بطرق احترافية تساعد عمالئنا
							على اتخاذ القرارات االستثمارية الصحيحة بعد دراسة تلك االستثمارات
							وخصائصها والتعرف على نقاط القوة والضعف وبذل العناية في دراسة السوق
							والعوامل المؤثرة على كافة أنواع االستثمارات العقارية المختلفة .
						</ParagraphContent>
					</div>
				</div>
			</section>
