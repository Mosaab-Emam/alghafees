<nav class="sidebar sidebar-offcanvas" id="sidebar">
    <ul class="nav">
        ...
        <!---->
        @if (can('services.index'))
        <li class="nav-item {{ Request::routeIs('admin.privacyPolicy.*') ? 'active' : '' }}">
            <a class="nav-link" href="{{ route('admin.privacyPolicy.index') }}">
                <i class="icon-user menu-icon"></i>
                <span class="menu-title">@lang('admin.privacyPolicy') </span>
            </a>
        </li>
        @endif
