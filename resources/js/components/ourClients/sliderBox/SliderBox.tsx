...
const SliderBox = () => {
	...
	return (
		<div className='relative'>
			...
			<ArrowsButtons
				position={"-top-10 left-0 md:my-0 my-8"}
				swiperRef={swiperRef}
				isEnd={isEnd}
			...
			{/* Swiper Component */}
			<Bullet position='md:-top-[7px] top-[24px] -right-[4px]' blue={true} />
			<section className='our-clients-swiper  md:w-[589px] w-[350px] md:h-[328px] h-auto md:mt-0 mt-8'>
				<Swiper
					onBeforeInit={(swiper) => {
