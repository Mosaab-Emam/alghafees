...
<head>
    ...
    <link rel="stylesheet" href="{{ asset("/scribe/css/theme-default.style.css") }}" media="screen">
    <link rel="stylesheet" href="{{ asset("/scribe/css/theme-default.print.css") }}" media="print">
    ...
    <script src="{{ asset("/scribe/js/tryitout-4.38.0.js") }}"></script>

    <script src="{{ asset("/scribe/js/theme-default-4.38.0.js") }}"></script>
...
<body data-languages="[&quot;bash&quot;,&quot;javascript&quot;]">
    ...
    <div class="page-wrapper">
        ...
        <div class="content">
            ...
            <h2 id="categories-GETapi-categories-goals">Fetch goals</h2>
    ...
    &quot;data&quot;: [
        ...
        },
        {
            ...
            <span id="execution-results-GETapi-categories-goals" hidden>
                <blockquote>Received response<span id="execution-response-status-GETapi-categories-goals"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-GETapi-categories-goals" data-method="GET" data-path="api/categories/goals" data-authed="0"
                ...
                <h3>
                    ...
                    <button type="button"
                        ...
                        id="btn-tryout-GETapi-categories-goals" onclick="tryItOut('GETapi-categories-goals');">Try it
                        out ⚡
                    </button>
                    <button type="button"
                        style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-canceltryout-GETapi-categories-goals" onclick="cancelTryOut('GETapi-categories-goals');"
                        hidden>Cancel 🛑
                    </button>&nbsp;&nbsp;
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-GETapi-categories-goals" data-initial-text="Send Request 💥"
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type" data-endpoint="GETapi-categories-goals"
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Accept" data-endpoint="GETapi-categories-goals"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
            ...
            <h2 id="categories-GETapi-categories-types">Fetch types</h2>
    ...
    &quot;data&quot;: [
        ...
        },
        {
            ...
            <span id="execution-results-GETapi-categories-types" hidden>
                <blockquote>Received response<span id="execution-response-status-GETapi-categories-types"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-GETapi-categories-types" data-method="GET" data-path="api/categories/types" data-authed="0"
                data-hasfiles="0" data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="button"
                        style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-tryout-GETapi-categories-types" onclick="tryItOut('GETapi-categories-types');">Try it
                        out ⚡
                    </button>
                    <button type="button"
                        style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-canceltryout-GETapi-categories-types" onclick="cancelTryOut('GETapi-categories-types');"
                        hidden>Cancel 🛑
                    </button>&nbsp;&nbsp;
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-GETapi-categories-types" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type" data-endpoint="GETapi-categories-types"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Accept" data-endpoint="GETapi-categories-types"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
            ...
            <h2 id="categories-GETapi-categories-entities">Fetch entities</h2>
    ...
    &quot;data&quot;: [
        ...
        },
        {
            ...
            <span id="execution-results-GETapi-categories-entities" hidden>
                <blockquote>Received response<span id="execution-response-status-GETapi-categories-entities"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-GETapi-categories-entities" data-method="GET" data-path="api/categories/entities"
                ...
                <h3>
                    ...
                    <button type="button"
                        style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-tryout-GETapi-categories-entities" onclick="tryItOut('GETapi-categories-entities');">Try
                        it out ⚡
                    </button>
                    <button type="button"
                        style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    ...
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-GETapi-categories-entities" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    <input type="text" style="display: none" name="Content-Type"
                        data-endpoint="GETapi-categories-entities" value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Accept" data-endpoint="GETapi-categories-entities"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
            ...
            <h2 id="categories-GETapi-categories-usages">Fetch usages</h2>
    ...
    &quot;data&quot;: [
        ...
        },
        {
            ...
            <span id="execution-results-GETapi-categories-usages" hidden>
                <blockquote>Received response<span id="execution-response-status-GETapi-categories-usages"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-GETapi-categories-usages" data-method="GET" data-path="api/categories/usages" data-authed="0"
                data-hasfiles="0" data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="button"
                        style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-tryout-GETapi-categories-usages" onclick="tryItOut('GETapi-categories-usages');">Try it
                        out ⚡
                    </button>
                    <button type="button"
                        style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    ...
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-GETapi-categories-usages" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type"
                        data-endpoint="GETapi-categories-usages" value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Accept" data-endpoint="GETapi-categories-usages"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
...
fetch(url, {
    ...
    body: JSON.stringify(body),
            ...
            <span id="execution-results-POSTapi-rate-requests" hidden>
                <blockquote>Received response<span id="execution-response-status-POSTapi-rate-requests"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-POSTapi-rate-requests" data-method="POST" data-path="api/rate-requests" data-authed="0"
                data-hasfiles="0" data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="button"
                        style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-tryout-POSTapi-rate-requests" onclick="tryItOut('POSTapi-rate-requests');">Try it out ⚡
                    </button>
                    <button type="button"
                        style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-canceltryout-POSTapi-rate-requests" onclick="cancelTryOut('POSTapi-rate-requests');"
                        hidden>Cancel 🛑
                    </button>&nbsp;&nbsp;
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-POSTapi-rate-requests" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type" data-endpoint="POSTapi-rate-requests"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Accept" data-endpoint="POSTapi-rate-requests"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    <small>string</small>&nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="name" data-endpoint="POSTapi-rate-requests"
                        value="رضا عياد" data-component="body">
                    <br>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    <small>string</small>&nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="mobile" data-endpoint="POSTapi-rate-requests"
                        value="0545853228" data-component="body">
                    <br>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    <small>string</small>&nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="email" data-endpoint="POSTapi-rate-requests"
                        value="redayadmm1234@gmail.com" data-component="body">
                    <br>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    <small>string</small>&nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="address" data-endpoint="POSTapi-rate-requests"
                        value="شارع النصر، حي النصر، مدينة الرياض" data-component="body">
                    <br>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    <small>integer</small>&nbsp;
                    &nbsp;
                    <input type="number" style="display: none" step="any" name="goal_id"
                        data-endpoint="POSTapi-rate-requests" value="1" data-component="body">
                    <br>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    <small>string</small>&nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="notes" data-endpoint="POSTapi-rate-requests"
                        value="يرجى التواصل معي في أقرب وقت ممكن" data-component="body">
                    <br>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    <small>integer</small>&nbsp;
                    &nbsp;
                    <input type="number" style="display: none" step="any" name="type_id"
                        data-endpoint="POSTapi-rate-requests" value="1" data-component="body">
                    <br>
                    <p>The id of an existing record in the categories table. Example: <code>1</code></p>
                </div>
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    <small>string</small>&nbsp;
                    <i>optional</i> &nbsp;
                    <input type="text" style="display: none" name="real_estate_details"
                        data-endpoint="POSTapi-rate-requests" value="يحتوي على 3 غرف نوم وصالة ومطبخ وحمامين"
                        data-component="body">
                    <br>
                    <p>More details about the property. Example: <code>يحتوي على 3 غرف نوم وصالة ومطبخ وحمامين</code>
                    </p>
                </div>
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    <small>integer</small>&nbsp;
                    <i>optional</i> &nbsp;
                    <input type="number" style="display: none" step="any" name="entity_id"
                        data-endpoint="POSTapi-rate-requests" value="1" data-component="body">
                    <br>
                    <p>The id of an existing record in the categories table. Example: <code>1</code></p>
                </div>
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    <small>integer</small>&nbsp;
                    &nbsp;
                    <input type="number" style="display: none" step="any" name="real_estate_age"
                        data-endpoint="POSTapi-rate-requests" value="5" data-component="body">
                    <br>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    <small>integer</small>&nbsp;
                    &nbsp;
                    <input type="number" style="display: none" step="any" name="real_estate_area"
                        data-endpoint="POSTapi-rate-requests" value="200" data-component="body">
                    <br>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    <small>integer</small>&nbsp;
                    <i>optional</i> &nbsp;
                    <input type="number" style="display: none" step="any" name="usage_id"
                        data-endpoint="POSTapi-rate-requests" value="1" data-component="body">
                    <br>
                    <p>The id of an existing record in the categories table. Example: <code>1</code></p>
                </div>
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    <small>numeric</small>&nbsp;
                    <i>optional</i> &nbsp;
                    <input type="text" style="display: none" name="latitude" data-endpoint="POSTapi-rate-requests"
                        value="24.7136" data-component="body">
                    <br>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    <small>numeric</small>&nbsp;
                    <i>optional</i> &nbsp;
                    <input type="text" style="display: none" name="longitude" data-endpoint="POSTapi-rate-requests"
                        value="46.6753" data-component="body">
                    <br>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    <small>string</small>&nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="location" data-endpoint="POSTapi-rate-requests"
                        value="شارع النصر، حي النصر، مدينة الرياض" data-component="body">
                    <br>
